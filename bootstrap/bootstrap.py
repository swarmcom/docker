...
registrarHost = 'sipxregistrar' + '.' + sipDomain
configuredIp = socket.gethostbyname(socket.gethostname())
primaryIp = configuredIp
primaryFqdn = fqdn
secret = subprocess.getoutput("head -c 18 /dev/urandom | base64")
